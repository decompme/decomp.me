...
COMPILATION_TIMEOUT_SECONDS = env("COMPILATION_TIMEOUT_SECONDS", int)
DECOMPILATION_TIMEOUT_SECONDS = env("DECOMPILATION_TIMEOUT_SECONDS", int)
ASSEMBLY_TIMEOUT_SECONDS = env("ASSEMBLY_TIMEOUT_SECONDS", int)
OBJDUMP_TIMEOUT_SECONDS = env("OBJDUMP_TIMEOUT_SECONDS", int)
