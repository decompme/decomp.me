...
# PS1
PSYQ_MSDOS_CC = (
    'ls -la && cpp -P "$INPUT" | unix2dos > object.oc && cp ${COMPILER_DIR}/* . && '
    + 'ls -la && (HOME="." dosemu -dumb -f ${COMPILER_DIR}/dosemurc -K . -E "CC1PSX.EXE -quiet ${COMPILER_FLAGS} -o object.os object.oc") &&'
    + 'ls -la && (HOME="." dosemu -dumb -f ${COMPILER_DIR}/dosemurc -K . -E "ASPSX.EXE -quiet object.os -o object.oo") && '
    + 'ls -la && ${COMPILER_DIR}/psyq-obj-parser object.oo -o "$OUTPUT"'
)
