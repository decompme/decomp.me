...
const preferSmallLanguageServer = createPersistedState("preferSmallLanguageServer")
...
export const usePreferSmallLanguageServer = () => preferSmallLanguageServer(true)
